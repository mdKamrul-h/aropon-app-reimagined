...
export default function LoansScreen() {
  ...
  const load = useCallback(async () => {
    ...
    setLoans(await repo.getLoans(business.id));
  ...
  const overdue = useMemo(() => overdueInstallments(loans), [loans]);

  const totalBorrowed = loans.reduce((s, l) => s + (l.principal || 0), 0);

  const totalPaid = loans.reduce((s, l) => s + loanPaidAmount(l), 0);
  ...
  const onTimeRate = onTimeRatePercent(loans);
        ...
        <ScrollView contentContainerStyle={[styles.content, { paddingBottom: insets.bottom + 100 }]}>
          ...
          {overdue.length > 0 ? (
            ...
            >
              ...
              <Text style={[styles.alertText, { color: t.pay }]}>
                ...
                {toBnDigits(overdue.length)}টি কিস্তি বকেয়া — ৳{toBnDigits(overdue[0].inst.amount)}
          ...
          <View style={styles.summaryRow}>
            ...
            <SurfaceCard style={styles.summaryCard}>
              ...
              <TakaAmount amount={totalPaid} color={t.receive} size="sm" />
            ...
            <SurfaceCard style={styles.summaryCard}>
              ...
              <Text style={[styles.summaryLabel, { color: t.muted }]}>সময়মতো</Text>

              <Text style={[styles.rateText, { color: t.brand }]}>{toBnDigits(onTimeRate)}%</Text>
                  ...
                  <SurfaceCard style={styles.card}>
                    ...
                    {next ? (
                      ...
                      <Text style={[styles.due, { color: t.inkSecondary }]}>
                        ...
                        পরবর্তী কিস্তি: ৳{toBnDigits(next.amount)} · {next.dueDate}
