...
export type DayFilter = 'today' | 'yesterday' | 'month' | 'all';
    ...
    <View style={styles.row}>
      {OPTIONS.map((o) => {
        ...
        return (
          ...
          >
            <Text style={[styles.chipText, { color: active ? t.ink : t.inkSecondary }]}>
              {o.label}
            </Text>
          </Pressable>
        );
  ...
  return (
    <View style={styles.summaryRow}>
      ...
      <View style={[styles.card, cardSurfaceStyle(t), { backgroundColor: t.neutralTint }]}>
        ...
        <TakaAmount amount={income - expense} color={t.brand} size="sm" showSign />
      </View>
    </View>
  );
}
